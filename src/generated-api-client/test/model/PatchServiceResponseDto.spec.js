...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.PatchServiceResponseDto();
  });
  ...
  describe('PatchServiceResponseDto', function() {
    it('should create an instance of PatchServiceResponseDto', function() {
      // uncomment below and update the code to test PatchServiceResponseDto
      //var instance = new OpenApiDefinition.PatchServiceResponseDto();
      //expect(instance).to.be.a(OpenApiDefinition.PatchServiceResponseDto);
    });
