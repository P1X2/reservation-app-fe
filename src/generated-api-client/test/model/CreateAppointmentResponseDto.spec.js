...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.CreateAppointmentResponseDto();
  });
  ...
  describe('CreateAppointmentResponseDto', function() {
    it('should create an instance of CreateAppointmentResponseDto', function() {
      // uncomment below and update the code to test CreateAppointmentResponseDto
      //var instance = new OpenApiDefinition.CreateAppointmentResponseDto();
      //expect(instance).to.be.a(OpenApiDefinition.CreateAppointmentResponseDto);
    });
