...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.GetAppointmentDto();
  });
  ...
  describe('GetAppointmentDto', function() {
    it('should create an instance of GetAppointmentDto', function() {
      // uncomment below and update the code to test GetAppointmentDto
      //var instance = new OpenApiDefinition.GetAppointmentDto();
      //expect(instance).to.be.a(OpenApiDefinition.GetAppointmentDto);
    });
