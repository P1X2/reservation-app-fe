...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.GetUserDto();
  });
  ...
  describe('GetUserDto', function() {
    it('should create an instance of GetUserDto', function() {
      // uncomment below and update the code to test GetUserDto
      //var instance = new OpenApiDefinition.GetUserDto();
      //expect(instance).to.be.a(OpenApiDefinition.GetUserDto);
    });
