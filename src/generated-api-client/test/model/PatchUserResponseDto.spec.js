...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.PatchUserResponseDto();
  });
  ...
  describe('PatchUserResponseDto', function() {
    it('should create an instance of PatchUserResponseDto', function() {
      // uncomment below and update the code to test PatchUserResponseDto
      //var instance = new OpenApiDefinition.PatchUserResponseDto();
      //expect(instance).to.be.a(OpenApiDefinition.PatchUserResponseDto);
    });
